...
/// <summary>
/// Permission names used by the eMarket authorization layer.
/// Business permissions are evaluated against the currently selected business.
/// Admin permissions are evaluated against global roles.
/// </summary>
public static class Permissions
{
    public static class Business
    {
        ...
        public const string Activate = "Business.Activate";
        public const string Suspend = "Business.Suspend";
        public const string Close = "Business.Close";
